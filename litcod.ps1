...
$image =  "https://github.com/FF0Math/RockStasPopStas/blob/main/LIT.png"

$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://github.com/FF0Math/RockStasPopStas/blob/main/LIT.png

# Download WAV file; replace link to $wav to add your own sound

$wav = "https://github.com/FF0Math/RockStasPopStas/blob/main/Stas.wav?raw=true"
